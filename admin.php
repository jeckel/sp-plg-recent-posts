<div class="wrap">
    ...
    <form name="wprpo_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <p><?php _e("Image width : "); ?><input type="text" name="wprpo_width" value="<?php echo $this->config['width']; ?>" size="20"><?php _e(" ex: 300" ); ?></p>
        <p><?php _e("Image height : "); ?><input type="text" name="wprpo_height" value="<?php echo $this->config['height']; ?>" size="20"><?php _e(" ex: 150" ); ?></p>
        <hr />
        <p class="submit">
